...
<jsp:include page="fragments/page_header.jsp">
	<jsp:param name="name" value="ВВЕДИТЕ ДАННЫЕ КАРТЫ" />
</jsp:include>
<div class="row">
		...
		<form class="form-horizontal" role="form" method="post"
			...
			<fieldset>
				<div class="form-group">
					<label class="col-sm-3 control-label" for="card-owner">Имя на карте</label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label" for="card-type">Тип карты</label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label" for="expiry-month">Срок действияe</label>
					<div class="col-sm-9">
						<div class="row">
							<div class="col-xs-3">
				...
				<div class="form-group">
					<div class="col-sm-3 col-sm-offset-3">
						<input type="hidden" name="hdnId"
							...
							value="${modalCreditCard.id == null ? 'Сохранить' : 'Обновить'}" />
					</div>
				</div>
			</fieldset>
		</form>
