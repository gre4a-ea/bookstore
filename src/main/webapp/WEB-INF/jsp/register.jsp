...
<div class="row">
	<jsp:include page="fragments/page_header.jsp">
		<jsp:param name="name" value="СОЗДАТЬ АККАУНТ" />
	</jsp:include>
		...
		<div class="col-sm-8 col-sm-offset-2">
			<form method="post"
				...
				<div class="form-group">
					<label for="email">Электронная почта:</label> <input type="email" name="email"
				...
				<div class="form-group">
					<label for="confirmPassword">Подтвердите пароль:</label> <input
